...
namespace BookStoreTest
{
    public class ConstantDataFiller : IDataFiller
    {
        public void Fill(DataContext dataContext)
        {
            ...
            dataContext.Events.Add(new Invoice(dataContext.Clients[0], dataContext.CopyDetailses[0],
                new DateTime(2006,4,14,2,34,44)));
            dataContext.Events.Add(new Invoice(dataContext.Clients[1], dataContext.CopyDetailses[1],
                new DateTime(2007,5,4,12,24,4)));
            dataContext.Events.Add(new Invoice(dataContext.Clients[2], dataContext.CopyDetailses[2],
                new DateTime(2004,9,5,1,14,54)));
            dataContext.Events.Add(new Invoice(dataContext.Clients[3], dataContext.CopyDetailses[3],
                new DateTime(2008,10,10,8,39,33)));
            dataContext.Events.Add(new Invoice(dataContext.Clients[4], dataContext.CopyDetailses[4],
